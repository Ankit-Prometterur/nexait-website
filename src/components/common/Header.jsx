          ...
          <div className="fixed inset-0 z-[999] bg-black/50 backdrop-blur-sm">
            <div className="h-full w-[320px] overflow-y-auto overscroll-contain bg-[#111827] border-r border-white/10 p-6 flex flex-col">
              ...
              <div className="mt-16 flex flex-col">
                <a
                  href="#"
                  className="border-b border-[#0000004d] py-5 text-md font-semibold"
                >
                  About
                </a>

                <div className="border-b border-[#0000004d] py-5">
                  <button
                    onClick={() => setMobileServicesOpen(!mobileServicesOpen)}
                    className="flex w-full items-center justify-between text-md font-semibold"
                  >
                    Services
                  ...
                  {mobileServicesOpen && (
                    <div className="mt-6 space-y-6 pl-2">
                      <div className="border-t border-[#80848d33]">
                        <h4 className="mt-2 text-[14px] font-bold text-white flex gap-1 text-center items-center">
                        ...
                        <ul className="mt-3 space-y-2 text-[12px] text-white">
              ...
              <div className="mt-auto pt-10">
                <button className="w-full rounded-full bg-[#ed5b2d] py-3 text-md font-semibold">
                  Contact Us
                </button>
              </div>
            </div>
